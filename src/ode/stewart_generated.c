 ...
 *
 * Source: models.cellml.org/exposure/38cf8387b0707f0ef6947f009710aeb5/
 *         stewart_aslanidi_noble_noble_boyett_zhang_2009.cellml
 *         CellML codegen view: @@cellml_codegen/C
 *
 * Verbatim CellML auto-generated C, with three changes:
 *   1. Function names prefixed with "stewart_" to avoid linker collision
 *      with tt06_generated.c (same upstream codegen template).
 *   2. <math.h> included explicitly so exp/pow/log resolve.
 *   3. Removed unused VOI-stamped print statements (codegen produces none here).
 *
 * Do not hand-edit. To refresh, re-paste the codegen output from CellML
 * and re-apply the rename:  sed -i 's/^void$/void stewart/'  trick or
 * just diff against this file.
 *
...
void
stewart_initConsts(double* CONSTANTS, double* RATES, double *STATES)
{
...
void
stewart_computeRates(double VOI, double* CONSTANTS, double* RATES, double* STATES, double* ALGEBRAIC)
{
...
RATES[10] = (ALGEBRAIC[5] - STATES[10])/ALGEBRAIC[43];
...
void
stewart_computeVariables(double VOI, double* CONSTANTS, double* RATES, double* STATES, double* ALGEBRAIC)
{
ALGEBRAIC[8] = 1.00000/(1.00000+exp((STATES[0]+20.0000)/7.00000));
ALGEBRAIC[22] =  1102.50*exp(- pow(STATES[0]+27.0000, 2.00000)/225.000)+200.000/(1.00000+exp((13.0000 - STATES[0])/10.0000))+180.000/(1.00000+exp((STATES[0]+30.0000)/10.0000))+20.0000;
ALGEBRAIC[9] = 0.670000/(1.00000+exp((STATES[0]+35.0000)/7.00000))+0.330000;
